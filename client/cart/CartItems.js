...
import {getCart,updateCart,removeItem} from './cart-helper.js'
...
const CartItems = (props) => {
    ...
    const handleChange = idx => evt => {
        ...
        if(evt.target.value == 0){
            ...
            updatedItems[idx].quantity = evt.target.value
        }
        setCartItems([...updatedItems])
        updateCart(idx,evt.target.value)
    }
    const removeItem = idx => evt => {
        let updatedCartItems =removeItem(idx)
            ...
            {cartItems.length > 0 ? (
                <span>
                    ...
                    <div className={classes.checkout}>
                        ...
                        {!props.checkout ? isAuthenticated() ? 
