                  ...
                  <CardContent>
                      ...
                      <br/>
                        ...
                        <span className={classes.filename}>
                            {values.image ? values.image.name : 'Select the image of the Item for auction'}
                        </span>
                      <br/>
                      <TextField id="name" label="Item Name"
                            className={classes.TextField} value={values.itemName}
